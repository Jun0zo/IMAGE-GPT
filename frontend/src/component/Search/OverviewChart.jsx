      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: "12px" }}>
            {result.likes_count} / {result.searches_count}
          </span>
        </Box>
      </Box>
    </Box>
    ...
    <Box sx={{ display: "flex", height: "100%", alignItems: "center" }}>
      <Box>
        ...
        <p style={{ fontSize: "14px" }}>
          유료 계정으로 업그레이드하여 IMAGE-GPT의 다양한 기능을 사용해보세요!
        </p>
  ...
  return (
    <Box sx={{ height: "75%" }}>
      ...
      <Box sx={{ textAlign: "center" }}>
        ...
        >
          <CheckIcon sx={{ marginRight: "3px", color: "rgb(0,210,122)" }} />
        ...
        <p style={{ fontSize: "12px" }}>
          전체 검색 {result.searches_count}건중 {result.downloads_count}건
          다운로드
        </p>
      </Box>
    </Box>
      ...
      {isLoading ? null : (
        <Grid container sx={{ width: "81%" }}>
          ...
          <Grid item xs={12} md={6} xl={3} sx={{ padding: "10px" }}>
            ...
            >
              {statisticsData &&
              statisticsData.gender &&
              statisticsData.gender.result ? (
                <Grid container>
                  <Grid
                    item
                    xs={4}
          ...
          <Grid item xs={12} md={6} xl={3} sx={{ padding: "10px" }}>
            ...
            >
              ...
              statisticsData.satisfaction.result ? (
                <SafisfactionShowTable
                  result={statisticsData.satisfaction.result}
                />
              ) : (
                <LoadingBox />
              )}
          ...
          <Grid item xs={12} lg={6} sx={{ padding: "10px" }}>
            <TableCard title="유사 키워드" sx={{ height: "330px" }}>
              {/* KeywordTable */}
              {statisticsData &&
              statisticsData.similarKeywords &&
              statisticsData.similarKeywords.result ? (
          ...
          <Grid item xs={12} lg={6} sx={{ padding: "10px" }}>
            ...
            <ChartCard title="기간별 검색 추이" sx={{ height: "300px" }}>
              {statisticsData &&
              statisticsData.monthlyTrend &&
              statisticsData.monthlyTrend.result ? (
                <SearchTrendByPeriodChart
                  result={statisticsData.monthlyTrend.result}
                />
              ) : (
                <LoadingBox />
              )}
          ...
          <Grid item xs={12} lg={3} sx={{ padding: "10px" }}>
            <TableCard title="비디오 정보" sx={{ height: "280px" }}>
              {/* VideoInfoTable */}
              {statisticsData &&
              statisticsData.relatedVideos &&
              statisticsData.relatedVideos.result ? (
          ...
          <Grid item xs={12} lg={6} sx={{ padding: "10px" }}>
            <ChartCard title="연령대별 검색 횟수" sx={{ height: "250px" }}>
              ...
              {statisticsData &&
              statisticsData.age &&
              statisticsData.age.result ? (
                <SearchCountByAgeGroupChart
                  result={statisticsData.age.result}
                />
              ) : (
                <LoadingBox />
              )}
          ...
          <Grid item xs={12} lg={3} sx={{ padding: "10px" }}>
            ...
            <ChartCard title="검색 대비 다운로드 비율" sx={{ height: "250px" }}>
              {statisticsData &&
              statisticsData.download &&
              statisticsData.download.result ? (
                <SearchDownloadRatioChart
                  result={statisticsData.download.result}
                  keyword={keyword}
                />
              ) : (
                <LoadingBox />
