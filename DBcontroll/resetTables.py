...
CREATE TABLE images (
    ...
    subtitle VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    emotion_score FLOAT,
...
CREATE TABLE downloads (
    ...
    keyword VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
cursor.execute('ALTER DATABASE service CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;')
